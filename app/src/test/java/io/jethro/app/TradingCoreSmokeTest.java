...
@SpringBootTest(properties = {"jethro.trading.sim-tick-interval-millis=1", "jethro.ai.enabled=false", "jethro.kafka.enabled=false", "jethro.persistence.enabled=false"})
