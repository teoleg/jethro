...
class VolatilityBudgetTest {
    ...
    private static FusionPlanner.Target target(String instrument, String qty) {
        ...
        return new FusionPlanner.Target(instrument, 10.0, 2, 1.0, 1.0, true, PRICE, q, BigDecimal.ZERO, q, List.of());
    }
    ...
    void preservesEverySignSoNoNameFlipsSide() {
        ...
        var shortName = new FusionPlanner.Target("B", -10.0, 2, 1.0, 1.0, true, PRICE,
