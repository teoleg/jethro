...
public final class FusionController {
    ...
    public FusionLifecycle.TargetBook targets() {
        ...
        return f == null
                ? new FusionLifecycle.TargetBook(0, false, 0, java.util.Map.of(), java.util.List.of(), null, 1.0, 0, 0, 1.0, 1.0, java.util.List.of(), 0, 0, "none", java.util.Map.of(), java.util.Map.of(), 0)
                : f.book();
    }
}
