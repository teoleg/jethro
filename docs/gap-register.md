...
| G4 | Order-book depth modelled | `onQuote` gains sizes; synthesized depth-at-touch from real volume; surfaced via /api/depth + sim page. Fills stay √-impact (full L2 depth-walk deferred to a real feed). | ADR-0033 | shipped |
