...
| [0056](0056-multi-source-market-data-coverage.md) | Multi-source market-data coverage — declarative per-instrument source precedence + freshness-guarded merge | Proposed | ◐ Interim (freshness guard + Yahoo fallback for the Finnhub names) |
