...
| [0056](0056-multi-source-market-data-coverage.md) | Multi-source market-data coverage — declarative per-instrument source precedence + freshness-guarded merge | Proposed | ◐ Interim (guard + Yahoo fallback + majors on Finnhub) |
