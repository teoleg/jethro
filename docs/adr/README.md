...
| [0063](0063-continuous-improvement-agent.md) | Continuous improvement agent — automate the observe→diagnose→advise→correct→rerun loop | Proposed | ☐ Not started (auto-runs the post-mortem loop; bounded-config auto-tune + PR/ADR proposal for code/money dials; never edits the deterministic floor — invariant 7 / ADR-0016) |
