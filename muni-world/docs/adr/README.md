...
**making it coherent** (0007 identity, 0010 document extraction, 0011 quality/coverage). Analytics (OAS on
callable munis) is the deferred north star — the data model in 0006 is built to serve it.
